...
public class CartSpecification {
    public static Specification<Cart> hasMedicineName(String medicineName) {
    ...
    public static Specification<Cart> hasQuantity(Integer quantity) {
        return (root, query, criteriaBuilder) -> {
            if (quantity == null) {
                return criteriaBuilder.conjunction();
            }
    ...
    public static Specification<Cart> hasExpireDate(LocalDate expireDateBegin, LocalDate expireDateEnd) {
        return (root, query, criteriaBuilder) -> {
